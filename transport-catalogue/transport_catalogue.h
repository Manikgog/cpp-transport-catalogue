...
public:
    ...
    const std::optional<std::set<std::string_view> > GetBusesByStopName(std::string_view name) const;
...
private:
    ...
    std::unordered_map<std::string_view, std::set<std::string_view> > stop_name_to_buses_;
};
